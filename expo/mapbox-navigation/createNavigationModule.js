function createNavigationModule({
  ...
  function getMapViewTag(mapViewRef) {
    ...
    const tag = mapView ? findNodeHandle(mapView) : null;
  ...
  function getRetainedTripSessionOptions() {
    return {
      foregroundService: enhancedLocationForegroundServiceConsumerCount > 0,
    };
  }
  ...
  function addTripSessionStateListener(listener) {
    ...
    return eventEmitter.addListener(TRIP_SESSION_STATE_EVENT_NAME, listener);
  }
