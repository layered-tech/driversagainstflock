...
required_paths = {
    ...
    "operations/bin/activate-changeset-feed.sh",
    ...
    "operations/bin/fetch-changeset-diffs.py",
    ...
    "operations/bin/import-changesets.py",
    "operations/bin/initialize-global-stack.sh",
    "operations/bin/metrics.sh",
    "operations/bin/bootstrap-changesets-core.sh",
    "operations/bin/bootstrap-changesets.sh",
    "operations/bin/changeset-update.sh",
    "operations/bin/changeset-backfill.sh",
    "operations/bin/refresh-changesets.sh",
    ...
    "operations/systemd/daf-osm-changeset-bootstrap.service",
    "operations/systemd/daf-osm-changeset-update.service",
    "operations/systemd/daf-osm-changeset-update.timer",
    "operations/systemd/daf-osm-changeset-backfill.service",
    "operations/systemd/daf-osm-changeset-backfill.timer",
    "operations/systemd/daf-osm-changeset-activate.service",
    "operations/systemd/daf-osm-changeset-refresh.service",
    ...
    "database/osm2pgsql/production/changesets-bootstrap-load.sql",
    "database/osm2pgsql/production/changesets-load.sql",
...
for endpoint in (
    ...
    "https://osm-planet-us-west-2.s3.dualstack.us-west-2.amazonaws.com/discussions/osm",
):
