...
test('privacy policy uses the dedicated DAF policy page', function () {
    ...
    expect($privacyPage)
        ...
        ->toContain('guided navigation')
        ->toContain('phone-started free drive')
        ->toContain('Android Auto or CarPlay')
        ->toContain('Parked-only automotive connections are not saved')
